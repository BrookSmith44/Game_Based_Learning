<?php
/**
 * Page to display students and provide options to add, edit and delete 
 ...
 */
 ...
 $app->get('/listStudents', function(Request $request, Response $response) use ($app) {
